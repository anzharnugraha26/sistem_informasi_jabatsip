<form action="{{ url('update-surat-masuk') }}" enctype="multipart/form-data" method="POST">
    @csrf
    ...
    <div class="row">
        <div class="col-md-6 mb-2">
            ...
            <input type="text" class="form-control" name="no_surat_masuk" value="{{ $s->no_surat_masuk }}" required>
        </div>
        <div class="col-md-6 mb-2">
