<form action="{{ url('update-surat-keluar') }}" enctype="multipart/form-data" method="POST">
    @csrf
    ...
    <div class="row">
        <div class="col-md-6 mb-2">
            ...
            <input type="text" class="form-control" name="no_surat_masuk" value="{{ $s->no_surat_keluar }}" required>
        </div>
        <div class="col-md-6 mb-2">
            ...
            <select class="form-select" aria-label="Default select example" name="klasifikasi_surat">
                ...
                @foreach ($kl as $i)
                    <option value="{{ $i->nama_kategori }}"
                        {{ $s->klasifikasi_surat == $i->nama_kategori ? 'selected' : '' }}>
        ...
        <div class="col-md-6 mb-2">
            ...
            <input type="text" class="form-control" name="asal_surat" value="{{ $s->tujuan_surat }}" required>
        </div>
        <div class="col-md-6 mb-2">
